...
NAME = f'M{MODEL.__name__}_D{D_MODEL}_H{N_HEAD}_E{NUM_ENCODER_LAYERS}_D{NUM_DECODER_LAYERS}_F{DIM_FEEDFORWARD}_BS{BATCH_SIZE}_MS{MAX_STEPS}_LR{LR}'
...
_, _ = train(model, train_dataloader, val_dataloader, max_steps=MAX_STEPS, lr=LR, verbose_each=10, perplexity=True)